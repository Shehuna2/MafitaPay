...
FLW_CLIENT_ID = os.getenv("FLW_TEST_CLIENT_ID")
FLW_CLIENT_SECRET = os.getenv("FLW_TEST_CLIENT_SECRET")
FLW_ENCRYPTION_KEY = os.getenv("FLW_TEST_ENCRYPTION_KEY")
FLW_HASH_SECRET = os.getenv("FLW_HASH_SECRET")
FLW_BASE_URL = os.getenv("FLW_TEST_BASE_URL")
FLW_API_VERSION = os.getenv("FLW_TEST_API_VERSION", "v4")

# FLW_TEST_API_VERSION = os.getenv("FLW_TEST_API_VERSION", "v4")
# FLW_TEST_CLIENT_ID = os.getenv("FLW_TEST_CLIENT_ID")
# FLW_TEST_CLIENT_SECRET = os.getenv("FLW_TEST_CLIENT_SECRET")
# FLW_TEST_BASE_URL = os.getenv("FLW_TEST_BASE_URL")
