...
# PI_RECEIVE_DETAILS = json.loads(os.getenv("PI_RECEIVE_DETAILS", "{}"))
...
POL_RPC_URL = os.getenv("POL_RPC_URL")
LINEA_RPC_URL = os.getenv("LINEA_RPC_URL")
...
AVAX_PRIVATE_KEY = os.getenv("AVAX_PRIVATE_KEY")
POL_PRIVATE_KEY = os.getenv("POL_PRIVATE_KEY")
LINEA_PRIVATE_KEY = os.getenv("LINEA_PRIVATE_KEY")



BSC_SENDER_ADDRESS = os.getenv("BSC_SENDER_ADDRESS")
ARB_SENDER_ADDRESS = os.getenv("ARB_SENDER_ADDRESS")
BASE_SENDER_ADDRESS = os.getenv("BASE_SENDER_ADDRESS")
OP_SENDER_ADDRESS = os.getenv("OP_SENDER_ADDRESS")
AVAX_SENDER_ADDRESS = os.getenv("AVAX_SENDER_ADDRESS")
POL_SENDER_ADDRESS = os.getenv("POL_SENDER_ADDRESS")
LINEA_SENDER_ADDRESS = os.getenv("LINEA_SENDER_ADDRESS")




VTU_BASE_URL = os.getenv("VTU_BASE_URL", "https://vtu.ng/wp-json")
VTU_USERNAME = os.getenv("VTU_USERNAME")
VTU_PASSWORD = os.getenv("VTU_PASSWORD")

# Snippet: settings.py adjustments (ensure all env keys exist)
FLW_API_VERSION = os.getenv("FLW_API_VERSION", "v4")
FLW_LIVE_CLIENT_ID = os.getenv("FLW_LIVE_CLIENT_ID")
FLW_LIVE_CLIENT_SECRET = os.getenv("FLW_LIVE_CLIENT_SECRET")
FLW_LIVE_ENCRYPTION_KEY = os.getenv("FLW_LIVE_ENCRYPTION_KEY")
...
FLW_LIVE_V3_BASE_URL = os.getenv("FLW_LIVE_V3_BASE_URL", "https://api.flutterwave.com/v3")
FLW_LIVE_SECRET_KEY = os.getenv("FLW_LIVE_V3_SECRET_KEY")
FLW_LIVE_PUBLIC_KEY = os.getenv("FLW_LIVE_V3_PUBLIC_KEY")
FLW_LIVE_ENCRYPTION_KEY = os.getenv("FLW_LIVE_V3_ENCRYPTION_KEY")

FINCRA_TEST_BASE_URL = os.getenv("FINCRA_TEST_BASE_URL", "https://sandboxapi.fincra.com")
FINCRA_TEST_PUBLIC_KEY = os.getenv("FINCRA_TEST_PUBLIC_KEY")
FINCRA_TEST_SECRET_KEY = os.getenv("FINCRA_TEST_SECRET_KEY")
FINCRA_TEST_WEBHOOK_SECRET = os.getenv("FINCRA_TEST_WEBHOOK_SECRET")

FINCRA_LIVE_BASE_URL = os.getenv("FINCRA_LIVE_BASE_URL", "https://api.fincra.com")
FINCRA_LIVE_PUBLIC_KEY = os.getenv("FINCRA_LIVE_PUBLIC_KEY")
FINCRA_LIVE_SECRET_KEY = os.getenv("FINCRA_LIVE_SECRET_KEY")
FINCRA_LIVE_WEBHOOK_SECRET = os.getenv("FINCRA_LIVE_WEBHOOK_SECRET")
...
PAYMENTS_LIVE = os.getenv("PAYMENTS_LIVE", "false").lower() == "true"
# =========================
# PALMPAY (LIVE)
# =========================
